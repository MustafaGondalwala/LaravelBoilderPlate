...
@section('content')
@include('admin.layout.content_header', ['header' => 'Component', 'currenct_page' => 'List'])
                ...
                <div class="card">
                    <div class="card-header">
                        <div class="card-tools">
                            <a href="{{route('admin.component.add')}}" class="btn btn-primary float-right">
                                Add
                            </a>
                        </div>
                    </div>
...
<script>
    ...
    "ajax": {
        url: "{{route('admin.component.list',['ajax'=>'true'])}}",
        type: 'GET',
        data: function (d) {
